    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0);">Contestants</a>
                        </li>
                        <li class="slide">
                            <a href="{{ route('contestants.index') }}" class="side-menu__item">List Contestants</a>
                        </li>
                        <li class="slide">
                            <a href="{{ route('contestant.create') }}" class="side-menu__item">Add Contestants</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="{{ route('admin.leaderboard') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="{{ route('votes.index') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3" />
                            <path
                        ...
                        <span class="side-menu__label">Votes</span>
                    </a>
                </li>
                <!-- End::slide -->
